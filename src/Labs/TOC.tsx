...
export default function TOC() {
    ...
    return (
        <ul className="nav nav-pills">
            ...
            <li className="nav-item"><a id="wd-k" href="https://github.com/mhx83"
                className="nav-link">My GitHub</a></li>
            <li className="nav-item"><a id="wd-github-react" href="https://github.com/mhx83/kanbas-react-web-app"
                className="nav-link" target="_blank">Github-React</a></li>
            <li className="nav-item"><a id="wd-github-node" href="https://github.com/mhx83/kanbas-node-server-app"
